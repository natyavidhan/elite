...
import { MUSCLE_PATHS, UNLABELED_PATHS, VIEWBOX, WIDTH, HEIGHT } from '../constants/svgBackPaths';
...
export default function MuscleMapBack({ muscleVolumes, onMusclePress, size = 200 }: MuscleMapBackProps) {
