    ...
    <div className="bg-paper-100 border border-paper-400 rounded-[2px] px-4 py-3">
      ...
      >
        ...
        <input
          ...
          className="font-data w-16 bg-transparent border-b border-ink-900/20 focus:border-vermilion-600 py-1 text-sm text-right focus:outline-none placeholder:text-ink-300"
        ...
        <input
          ...
          className="font-data w-12 bg-transparent border-b border-ink-900/20 focus:border-vermilion-600 py-1 text-sm text-right focus:outline-none placeholder:text-ink-300"
          aria-label="New set reps"
        />
        <span className="text-xs text-ink-500">reps</span>
        <button
          type="submit"
          className="ml-auto flex items-center gap-1 text-xs text-vermilion-700 hover:text-vermilion-800 py-1 px-2 -mr-2"
        >
